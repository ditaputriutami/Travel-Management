...
@section('page-subtitle', 'Input data pengeluaran operasional baru')
        ...
        <form action="{{ route('biaya-operasional.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="nama_biaya" id="nama_biaya" class="form-input"
                    placeholder="Contoh: Biaya Gaji Sopir" value="{{ old('nama_biaya') }}" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number" name="nominal" id="nominal" class="form-input"
                        placeholder="0" value="{{ old('nominal') }}" step="0.01" min="0" required>
            ...
            <div class="mb-6">
                ...
                <select name="akun_beban_id" id="akun_beban_id" class="form-input" required>
                    ...
                    @foreach($akun as $a)
                    <option value="{{ $a->id }}" {{ old('akun_beban_id') == $a->id ? 'selected' : '' }}>
            ...
            <div class="mb-6">
                ...
                <textarea name="keterangan" id="keterangan" class="form-input" rows="3"
                    placeholder="Catatan atau keterangan biaya...">{{ old('keterangan') }}</textarea>
