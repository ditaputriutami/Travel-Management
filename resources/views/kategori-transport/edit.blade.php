...
@section('page-subtitle', 'Ubah data kendaraan')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="kode_kendaraan" id="kode_kendaraan" class="form-input"
                        value="{{ old('kode_kendaraan', $kategoriTransport->kode_kendaraan) }}" required>
                ...
                <div>
                    ...
                    <input type="text" name="nomor_polisi" id="nomor_polisi" class="form-input"
                        value="{{ old('nomor_polisi', $kategoriTransport->nomor_polisi) }}" required>
                    @error('nomor_polisi')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select name="jenis_kendaraan" id="jenis_kendaraan" class="form-input" required>
                        ...
                        <option value="mobil" {{ old('jenis_kendaraan', $kategoriTransport->jenis_kendaraan) == 'mobil' ? 'selected' : '' }}>Mobil</option>
                        <option value="bus" {{ old('jenis_kendaraan', $kategoriTransport->jenis_kendaraan) == 'bus' ? 'selected' : '' }}>Bus</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="merk_tipe" id="merk_tipe" class="form-input"
                        value="{{ old('merk_tipe', $kategoriTransport->merk_tipe) }}" required>
                    @error('merk_tipe')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="number" name="tahun_kendaraan" id="tahun_kendaraan" class="form-input"
                        value="{{ old('tahun_kendaraan', $kategoriTransport->tahun_kendaraan) }}" min="1900" max="{{ date('Y') + 1 }}" required>
                ...
                <div>
                    ...
                    <input type="number" name="kapasitas_penumpang" id="kapasitas_penumpang" class="form-input"
                        value="{{ old('kapasitas_penumpang', $kategoriTransport->kapasitas_penumpang) }}" min="1" required>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <select name="status_kendaraan" id="status_kendaraan" class="form-input" required>
                        ...
                        <option value="tersedia" {{ old('status_kendaraan', $kategoriTransport->status_kendaraan) == 'tersedia' ? 'selected' : '' }}>Tersedia</option>
                        <option value="disewa" {{ old('status_kendaraan', $kategoriTransport->status_kendaraan) == 'disewa' ? 'selected' : '' }}>Disewa</option>
                        <option value="perawatan" {{ old('status_kendaraan', $kategoriTransport->status_kendaraan) == 'perawatan' ? 'selected' : '' }}>Perawatan</option>
                    </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="number" name="tarif_12_jam" id="tarif_12_jam" class="form-input"
                            value="{{ old('tarif_12_jam', $kategoriTransport->tarif_12_jam) }}" min="0" step="0.01" required>
                        @error('tarif_12_jam')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="tarif_24_jam" id="tarif_24_jam" class="form-input"
                            value="{{ old('tarif_24_jam', $kategoriTransport->tarif_24_jam) }}" min="0" step="0.01" required>
                        @error('tarif_24_jam')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="tarif_overtime_per_jam" id="tarif_overtime_per_jam" class="form-input"
                            value="{{ old('tarif_overtime_per_jam', $kategoriTransport->tarif_overtime_per_jam) }}" min="0" step="0.01">
